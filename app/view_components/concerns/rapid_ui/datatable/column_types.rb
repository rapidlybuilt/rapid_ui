  ...
  module Datatable
    ...
    module ColumnTypes
      ...
      included do
        ...
        column_type :integer, :html do |value|
        ...
        column_type :float, :html do |value|
        ...
        column_type :datetime, :html do |value|
        ...
        # Renders a datetime in a database-friendly format.
        # @example DateTime.new(2024, 1, 15, 14, 30) => "2024-01-15 14:30:00 UTC"
        ...
        column_type :boolean, :html do |value|
          value ? "Yes" : "No"
        end

        # Renders a boolean value as true or false.
        ...
        # @example 1234.5 => "$1,234.50"
        column_type :currency, :html do |value|
        ...
        column_type :percentage, :html do |value|
