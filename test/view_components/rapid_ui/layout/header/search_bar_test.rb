...
module RapidUI
  module Layout
    module Header
      class SearchBarTest < ViewComponentTestCase
        described_class SearchBar

        test "renders a basic search component" do
          render_inline build(dynamic_path: "/search")

          assert_selector "[data-controller]"
        end

        test "renders search with custom path" do
          render_inline build(dynamic_path: "/custom/search")
        ...
        test "renders with custom search icon" do
          render_inline build(dynamic_path: "/search") do |search|
        ...
        test "renders with custom CSS class" do
          render_inline build(dynamic_path: "/search", class: "custom-search")
