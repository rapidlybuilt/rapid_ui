module Components::Controls::DropdownsHelper
  def component_controls_dropdowns_variants
    demo_components do |c|
      c << new_primary_dropdown("Primary") do |dropdown|
        dropdown.menu.with_item("Action 1", "#")
        dropdown.menu.with_item("Action 2", "#")
      end
  ...
  def component_controls_dropdowns_sizes
    demo_components do |c|
      c << new_primary_dropdown("Small", size: "sm") do |dropdown|
        dropdown.menu.with_item("Action 1", "#")
        dropdown.menu.with_item("Action 2", "#")
        dropdown.menu.with_item("Action 3", "#")
      end
  ...
  def component_controls_dropdowns_positioning
    demo_components do |c|
      ...
      c << new_primary_dropdown("Drop Up", direction: "up") do |dropdown|
        dropdown.menu.with_item("Up", "#")
        dropdown.menu.with_item("Position", "#")
      end
  ...
  def component_controls_dropdowns_active_and_disabled
    demo_components do |c|
      c << new_primary_dropdown("Active & Disabled") do |dropdown|
        dropdown.menu.with_item("Active Item", "#", active: true)
        dropdown.menu.with_item("Normal Item", "#")
        dropdown.menu.with_item("Disabled Item", "#", disabled: true)
      end

      c << new_secondary_dropdown("With Icons") do |dropdown|
        dropdown.menu.with_item("Active Profile", "#", icon: "user", active: true)
        dropdown.menu.with_item("Settings", "#", icon: "settings")
        dropdown.menu.with_item("Disabled Billing", "#", icon: "hash", disabled: true)
      end

      c << new_success_dropdown("Success Variant") do |dropdown|
        dropdown.menu.with_item("Active Success", "#", active: true)
        dropdown.menu.with_item("Normal Success", "#")
        dropdown.menu.with_item("Disabled Success", "#", disabled: true)
      end

      c << new_danger_dropdown("Danger Variant") do |dropdown|
        dropdown.menu.with_item("Active Danger", "#", active: true)
        dropdown.menu.with_item("Normal Danger", "#")
        dropdown.menu.with_item("Disabled Danger", "#", disabled: true)
      end
    end
  end
  ...
  def component_controls_dropdowns_with_icons
    demo_components do |c|
      c << new_primary_dropdown(icon("user"), "Profile") do |dropdown|
        dropdown.menu.with_item("Profile", "#", icon: "user")
        dropdown.menu.with_item("Settings", "#", icon: "settings")
        dropdown.menu.with_item("Sign Out", "#", icon: "x")
      end

      c << new_secondary_dropdown(icon("settings"), "Options") do |dropdown|
        dropdown.menu.with_item("Search", "#", icon: "search")
        dropdown.menu.with_item("Help", "#", icon: "info")
        dropdown.menu.with_item("Delete", "#", icon: "trash")
      end
  ...
  def component_controls_dropdowns_menu_headers_and_dividers
    demo_components do |c|
      c << new_primary_dropdown("Primary") do |dropdown|
        dropdown.menu.with_header("Account")
        dropdown.menu.with_item("Profile", "#")
